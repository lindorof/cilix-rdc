...
void sp_cps_init(sp_cps_t* cps) {
    ...
    cps->json = &cps->json__t; {
		...
		cps->json->get_gstr = cilix_json_get_gstr;
		cps->json->get_64str = cilix_json_get_64str;
		...
		cps->json->get_arr_gstr = cilix_json_get_arr_gstr;
		cps->json->get_arr_64str = cilix_json_get_arr_64str;
		...
		cps->json->add_gstr = cilix_json_add_gstr;
		cps->json->add_64str = cilix_json_add_64str;
		...
		cps->json->add_arr_gstr = cilix_json_add_arr_gstr;
		cps->json->add_arr_64str = cilix_json_add_arr_64str;
