...
typedef char*  (*sp_cp_json_get_gstr)(void* obj, char* name);
typedef char*  (*sp_cp_json_get_64str)(void* obj, char* name, int* len);
...
typedef char*  (*sp_cp_json_get_arr_gstr)(void* obj,int idx);
typedef char*  (*sp_cp_json_get_arr_64str)(void* obj, int idx, int* len);
...
typedef void* (*sp_cp_json_add_gstr)(void* obj, char* name, char* val);
typedef void* (*sp_cp_json_add_64str)(void* obj, char* name, char* val, int len);
...
typedef void* (*sp_cp_json_add_arr_gstr)(void* obj, char* name, char* val);
typedef void* (*sp_cp_json_add_arr_64str)(void* obj, char* name, char* val, int len);
...
typedef struct sp_cp_json_s {
	...
	sp_cp_json_get_gstr get_gstr;
	sp_cp_json_get_64str get_64str;
	...
	sp_cp_json_get_arr_gstr get_arr_gstr;
	sp_cp_json_get_arr_64str get_arr_64str;
	...
	sp_cp_json_add_gstr add_gstr;
	sp_cp_json_add_64str add_64str;
	...
	sp_cp_json_add_arr_gstr add_arr_gstr;
	sp_cp_json_add_arr_64str add_arr_64str;
